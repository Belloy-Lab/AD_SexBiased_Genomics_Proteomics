...
file_path <- file.path(opt$Results_dir, "PWAS_VEP_matrix_1a.png")
ggsave(filename = file_path, plot = p_matrix, device = "png", width = 11, height = 9, dpi = 320)
...
file_path <- file.path(opt$Results_dir, "PWAS_VEP_matrix_2a.png")
ggsave(filename = file_path, plot = p_matrix, device = "png", width = 11, height = 9, dpi = 320)
