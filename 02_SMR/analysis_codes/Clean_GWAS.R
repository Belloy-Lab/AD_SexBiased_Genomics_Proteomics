...
option_list <- list(
  ...
  make_option("--female_gwas", type = "character", default = NULL,
              help = "Female GWAS summary statistics filename.", metavar = "Stage1-2-3_EUR_Female_AD_GWAS"),
  make_option("--male_gwas", type = "character", default = NULL,
              help = "Male GWAS summary statistics filename.", metavar = "Stage1-2-3_EUR_Male_AD_GWAS"),
