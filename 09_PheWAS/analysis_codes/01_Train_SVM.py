...
bim_topmed = pd.read_csv(
    "/mnt/barry/home/lia/HP/HP_SNPs_ADSP_ADRC/HP_imp_TOPMed.bim",
    delim_whitespace=True,
    header=None,
    names=["CHR", "SNP", "CM", "POS", "A1", "A2"]
)
bim_adsp = pd.read_csv(
    "/mnt/barry/home/lia/HP/HP_SNPs_ADSP_ADRC/HP_imp_ADSP_WGS.bim",
    delim_whitespace=True,
    header=None,
    names=["CHR", "SNP", "CM", "POS", "A1", "A2"]
)
bim_eur = pd.read_csv(
    "/mnt/barry/home/lia/HP/HP_SNPs_ADSP_ADRC/HP_haplotype_variant_PLINK_file_3506_EUR_samples.bim",
    delim_whitespace=True,
    header=None,
    names=["CHR", "SNP", "CM", "POS", "A1", "A2"]
)
...
bim_UKB = pd.read_csv(
    "/mnt/barry/home/lia/HP/UKB_for_HP1_impute/UKB_HP1_imputation.bim",
    delim_whitespace=True,
    header=None,
    names=["CHR", "SNP", "CM", "POS", "A1", "A2"]
)
