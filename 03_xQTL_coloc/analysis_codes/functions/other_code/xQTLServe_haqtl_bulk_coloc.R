### Preprocessing/Analysis code for Autosomal QTL analysis (xQTLServe haQTL ABF)
...
for (i in 1:nrow(all_suggestive_snps)) {
  ...
  source("/storage2/fs1/belloy2/Active/04_Code/$USER/xQTL/functions/autosome_haQTL_function_abf.R")  
