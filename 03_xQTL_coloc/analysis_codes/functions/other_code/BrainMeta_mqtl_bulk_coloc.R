### Preprocessing/Analysis code for Autosomal QTL analysis (BrainMeta mQTL ABF)
...
for (i in 1:nrow(all_suggestive_snps)) {
  ...
  source("/storage2/fs1/belloy2/Active/04_Code/$USER/xQTL/functions/autosome_mQTL_function_abf.R")  
