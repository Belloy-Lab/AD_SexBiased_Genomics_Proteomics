...
- CSF protein weights from [Western et al. 2024](https://www.nature.com/articles/s41588-024-01972-8).


```bash
python Analysis_codes/HP_Train_SVM.py

python Analysis_codes/HP_prediction.py

Rscript Analysis_codes/HP_pheWAS.R
```
