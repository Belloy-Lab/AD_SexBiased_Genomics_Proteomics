#!/usr/bin/env Rscript
### Master Script for xQTL pipeline SUSiE - on consistent script
...
# Define variables not read in from bash script for susie
...
# Source bulk colocalization susie
source("/storage2/fs1/belloy2/Active/04_Code/$USER/xQTL/functions/bulk_colocalization_susie.R")
