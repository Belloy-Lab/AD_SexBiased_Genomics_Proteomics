### Preprocessing/Analysis code for Autosomal QTL analysis (NGI CSF Female pQTL SuSiE)
...
##########################################
## pQTL file list
source_dir = "/storage1/fs1/belloy/Active/02_Data/01_Incoming/NGI_CSF_sex-stratified_pQTL_files/other/pQTL-female-results/"
