### Preprocessing/Analysis code for Autosomal QTL analysis (ARIC pQTL SuSiE)
...
##########################################
## pQTL file list
source_dir = "/storage1/fs1/belloy/Active/02_Data/01_Incoming/QTL/ARIC/EA/EA/"
