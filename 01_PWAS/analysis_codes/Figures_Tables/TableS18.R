...
xb <- fread(paste0(opt$noUKB_brain_dir, f_dir, opt$noUKB_female_primary_brain_PWASfile)) 
yb <- fread(paste0(opt$noUKB_brain_dir, m_dir, opt$noUKB_male_primary_brain_PWASfile)) 
xc <- fread(paste0(opt$noUKB_CSF_dir, f_dir, opt$noUKB_female_primary_CSF_PWASfile)) 
yc <- fread(paste0(opt$noUKB_CSF_dir, m_dir, opt$noUKB_male_primary_CSF_PWASfile)) 
