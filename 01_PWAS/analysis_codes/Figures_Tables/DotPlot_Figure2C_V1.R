...
# Written by Danielle M. Read - Version 10
################################################################
...
# f_dat= fread(paste0(dir, "ADGC_ADSP_UKB_FinnGen_cc_rb.gen090.noAPOE.shared_var.W23nCSF.hg38_top-sex-specific-genes_dotplot_matrix.txt"))
# m_dat= fread(paste0(dir, "ADGC_ADSP_UKB_FinnGen_cc_rb.gen090.noAPOE.shared_var.W23nCSF.hg38_top-sex-specific-genes_dotplot_matrix.txt"))
...
fwrite(f_dat, paste0(dir, "ADGC_ADSP_UKB_FinnGen_Females_cc_rb.gen090.noAPOE.shared_var.W23nCSF.hg38_top-fsg_dotplot_matrix10.txt"), col.names = T, row.names = F, quote = F, sep = '\t', na = NA)
fwrite(m_dat, paste0(dir, "ADGC_ADSP_UKB_FinnGen_Males_cc_rb.gen090.noAPOE.shared_var.W23nCSF.hg38_top-msg_dotplot_matrix10.txt"), col.names = T, row.names = F, quote = F, sep = '\t', na = NA)
...
pdf(paste0(dir, "ADGC_ADSP_UKB_FinnGen_cc_rb.gen090.noAPOE.shared_var.ssg_W23nCSFc_dotplot_matrix10.pdf"), width = 4, height = 6)
plot(p)
dev.off()
