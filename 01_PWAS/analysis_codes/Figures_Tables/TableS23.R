...
x = fread(paste0(dir, opt$female_top_genel), header = T, sep = '\t') # /storage2/fs1/belloy2/Active/05_Projects/username/PWAS/Final_plots/ADGC_ADSP_UKB_FinnGen_Females_cc_rb.gen090.noAPOE.shared_var.W23nCSF.hg38_PWAS_noMHC_ext2Mb_top-female-specific-genes.txt
y = fread(paste0(dir, opt$male_top_gene), header = T, sep = '\t') # /storage2/fs1/belloy2/Active/05_Projects/username/PWAS/Final_plots/ADGC_ADSP_UKB_FinnGen_Males_cc_rb.gen090.noAPOE.shared_var.W23nCSF.hg38_PWAS_noMHC_ext2Mb_top-male-specific-genes.txt
...
w_AFR = fread(paste0(opt$PD_dir, fb_dir, opt$fb_combZ)) # /storage2/fs1/belloy2/Active/05_Projects/username/PWAS/EU_all/Brain/Sex/Female/ADGC_ADSP_UKB_FinnGen_Females_cc_rb.gen090.noAPOE.shared_var.hg19_eurLD_PWAS_W23_fsg_sex-het_comb-AFRad_full-Z.txt")
x_AFR = fread(paste0(opt$PD_dir, mb_dir, opt$mb_combZ)) # /storage2/fs1/belloy2/Active/05_Projects/username/PWAS/EU_all/Brain/Sex/Male/ADGC_ADSP_UKB_FinnGen_Males_cc_rb.gen090.noAPOE.shared_var.hg19_eurLD_PWAS_W23_msg_sex-het_comb-AFRad_full-Z.txt")
y_AFR = fread(paste0(opt$PD_dir, fc_dir, opt$fc_combZ)) # /storage2/fs1/belloy2/Active/05_Projects/username/PWAS/EU_all/CSF/Sex/Female/ADGC_ADSP_UKB_FinnGen_Females_cc_rb.gen090.noAPOE.shared_var.hg38_PWAS_NGI-CSFc_fsg_sex-het_comb-AFRad_full-Z.txt")
z_AFR = fread(paste0(opt$PD_dir, mc_dir, opt$mc_combZ)) # /storage2/fs1/belloy2/Active/05_Projects/username/PWAS/EU_all/CSF/Sex/Male/ADGC_ADSP_UKB_FinnGen_Males_cc_rb.gen090.noAPOE.shared_var.hg38_PWAS_NGI-CSFc_msg_sex-het_comb-AFRad_full-Z.txt")
